...
def inversa_de_triangular(M):
    ...
    # Usamos scipy para resolver el sistema triangular (Mx = I) #> Abuso de notacion, Mx es vector e I es matriz
    return scipy.linalg.solve_triangular(M,I)

    #> Para calcular la inversa de K en realidad habia que aprovechar que es diagonal y hacerlo a mano
