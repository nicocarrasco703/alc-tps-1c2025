...
import Correccion_template_funciones_NO_SUBIERON as TP1 #> Esto lo cambie yo. Incluso con esto sigue sin correr porque cambiaron 
                                                        #> cosas en su template del 1
#> Esto quedo sin corregir porque no anda sin las funciones del TP1.
